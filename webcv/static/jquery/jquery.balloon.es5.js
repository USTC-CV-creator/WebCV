...
(function ($) {
  ...
  var Meta = {
    ...
    getRelativeNames: function getRelativeNames(position) {
      var idx = {
        pos: {
          o: position, // origin
  ...
  (function () {
    // Method factories
    var Methods = {
      setBorder: function setBorder(pos, isVertical) {
      ...
      setPosition: function setPosition(pos, isVertical) {
        return function (value) {
    ...
    NumericalBoxElement.prototype = {
      ...
      active: function active() {
        this.isActive = true;digitalize(this);return this;
      },
    ...
    function digitalize(box, isVertical) {
      if (isVertical == null) {
        digitalize(box, true);return digitalize(box, false);
      }
  ...
  function makeupBalloon($target, $balloon, options) {
    ...
    if (options.tipSize > 0) {
      ...
      if ($balloon.data('outerTip')) {
        $balloon.data('outerTip').remove();$balloon.removeData('outerTip');
      }
      if ($balloon.data('innerTip')) {
        $balloon.data('innerTip').remove();$balloon.removeData('innerTip');
      }
    ...
    function makeTip(balloon, tip, m, tipSize, color) {
      ...
      tip.inactive()['setBorder' + m.camel.pos.f](tipSize)['setBorder' + m.camel.pos.c1](len)['setBorder' + m.camel.pos.c2](len)['set' + m.camel.pos.p1](m.isTopLeft ? -tipSize : balloon.inner[m.size.p])['set' + m.camel.pos.c1](balloon.inner[m.size.c] / options.tipPosition - len).active().$.css('border-' + m.pos.f + '-color', color);
    }
  }
  ...
  $.fn.showBalloon = function (options) {
    ...
    return this.each(function () {
      ...
      var contents = $.isFunction(options.contents) ? options.contents.apply(this) : options.contents || $target.attr('title') || $target.attr('alt');
      $target.removeAttr('title');
      if (!options.url && contents === '' || contents == null) {
        return;
      }
      ...
      if (options.url) {
        if (!$balloon.data('ajaxDisabled')) {
          ...
          $balloon.data('ajaxDelay', setTimeout(function () {
            $balloon.load($.isFunction(options.url) ? options.url.apply($target.get(0)) : options.url, function (res, sts, xhr) {
      ...
      $balloon.data('delay', setTimeout(function () {
        if (options.showAnimation) {
          options.showAnimation.apply($balloon.stop(true, true), [options.showDuration, function () {
        ...
        if (options.maxLifetime) {
          ...
          $balloon.data('maxLifetime', setTimeout(function () {
            $target.hideBalloon();
          }, options.maxLifetime));
        }
      }, options.delay));
    ...
    return this.each(function () {
      ...
      $balloon.data('minLifetime', setTimeout(function () {
        if (options.hideAnimation) {
          options.hideAnimation.apply($balloon.stop(true, true), [options.hideDuration, function (d) {
  ...
  $.balloon = {
    defaults: {
      ...
      hideDuration: 80, hideAnimation: function hideAnimation(d, c) {
        this.fadeOut(d, c);
      },
